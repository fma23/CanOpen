 ...
 * @file        CANopen.c
 * @ingroup     CO_CANopen
 * @version     SVN: \$Id: CANopen.c 46 2013-08-24 09:18:16Z jani22 $
...
CanTxMsgTypeDef      CAN1_TxMsg;                  /* CAN messge for sending           */
CanRxMsgTypeDef      CAN1_RxMsg;                  /* CAN message for receiving        */  
...
CO_ReturnError_t CO_init()
{
    ...
    //CO_CANsetConfigurationMode(ADDR_CAN1); // Taken care in CAN init
...
void CO_delete()
{
    ...
    //CO_CANsetConfigurationMode(ADDR_CAN1);  // taken care in CAN deinit
        ...
        uint16_t                timeDifference_ms)
{
    ...
    CO_SDO_process(
            ...
            timeDifference_ms,
            1000); /* Time out changed due to change in calling rate 1000 --> 65535 */
